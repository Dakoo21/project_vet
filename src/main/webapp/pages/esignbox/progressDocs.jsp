                ...
                <div class="container">
                    ...
                    <div class="board-header">
                        <p class="d-inline-flex gap-1">
                            ...
                            <a href="#" class="btn btn-primary" role="button" data-bs-toggle="button">대기</a>
                            <a href="#" class="btn btn-primary" role="button" data-bs-toggle="button">진행</a>
                            <a href="#" class="btn btn-primary" role="button" data-bs-toggle="button">예정</a>
                        </p>
                    </div>
                    <!-- 검색기 시작 -->
                    <div class="row">
