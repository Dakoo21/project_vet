    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">비밀번호를 알려드립니다!</h4>
...
<script>
        ...
        $("#modalBtn").click(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    displayuserID(response.userPass);
                },
    ...
    function displayuserID(userPass) {
        var userIdInput = $("#userIdInput");
        userIdInput.empty();
        if (userPass != null) {
            var row = "<span>" + "당신의 임시 비밀번호는 " + userPass + " 입니다.(로그인후 수정해주세요!!)" + "</span>";
