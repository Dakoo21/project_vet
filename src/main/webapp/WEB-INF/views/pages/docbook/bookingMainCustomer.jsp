    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div id='calendarTimeline'>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <!-- 진료비 -->
                                <div class="form-group" style="display: inline-block; width: 240px;">
                                    <label for="cost-estimate" style="display: inline-block; width: 70px;">예상진료비</label>
                                    <input type="text" id="cost-estimate" class="form-control" placeholder="입력해 주세요" style="display: inline-block; width: 150px;">
                                </div>
                                <!-- 담당의 -->
                                <div class="form-group" style="display: inline-block; width: 240px;">
                ...
                <!-- 조회 모달 -->
                <div id="reserveDetailModalAdmin" class="modal">
                    <div class="modal-content">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <!-- 진료비 -->
                                <div class="form-group" style="display: inline-block; width: 240px;">
                                    <label for="sel-cost" style="display: inline-block; width: 70px;">예상진료비</label>
                                    <span id="sel-cost">36,000</span>
                                </div>
                                <!-- 담당의 -->
                                <div class="form-group" style="display: inline-block; width: 240px;">
...
<script>
    ...
    // 모달 요소 가져오기
    var detailModal = document.getElementById("reserveDetailModalAdmin");
