                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group" style="display: inline-block; width: 240px;">
                                <label for="masterName" style="display: inline-block; width: 70px;">보호자명</label>
                                <input type="text" id="masterName" class="form-control" placeholder="입력해 주세요" style="display: inline-block; width: 150px;">
                            </div>
                            <!-- 동물선택 -->
                            <div class="form-group" style="display: inline-block; width: 240px;">
                            ...
                            <div class="form-group" style="display: inline-block; width: 240px;">
                                ...
                                <input type="text" id="reservationdate" class="form-control" style="display: inline-block; width: 150px;">
                            </div>
                            <!-- 예약시간 -->
                            <div class="form-group" style="display: inline-block; width: 240px;">
                                <label for="bookingStart" style="display: inline-block; width: 70px;">예약시간</label>
                                <select class="form-control select2" id="bookingStart" name="bookingStart" style="display: inline-block; width: 150px;">
                                    <option selected="selected" disabled>시간 선택</option>
                            ...
                            <div class="form-group" style="display: inline-block; width: 240px;">
                                ...
                                <select class="form-control select2" name="bookingType" style="display: inline-block; width: 150px;">
                                    <option selected="selected">선택</option>
                            ...
                            <!-- 담당의 -->
                                <div class="form-group" style="display: inline-block; width: 240px;">
                                    ...
                                    <select class="form-control select2" name="userPk"style="display: inline-block; width: 150px;">
                                        <option selected="selected">선택</option>
