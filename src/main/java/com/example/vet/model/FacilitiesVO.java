...
public class FacilitiesVO {
    ...
    @Builder
    public FacilitiesVO(int facilityReserveId, String facilityNm, String userNm, String animalNm,  int animalId, String animalBdate, String facilityReserveDt,String startTime, String endTime, int startInterval, int endInterval, int timeInterval, String facilityRemarks) {
