...
public class Sign {
    ...
    @Builder
    public Sign(Integer SIGN_PK, String SIGN_TITLE, String SIGN_CONTENT, String SIGN_DATE, String SIGN_RESERV_YEAR, String SIGN_DOCTYPE, Integer MEMBER_PK, Integer ADOPT_PK, String selectedvalue) {
